...
// Get 2-legged token directly and send it as a response
...
//Ensure 2-legged token is available
exports.ensure2LeggedToken = async (req, res, next) => {
  try {
    ...
    res.status(500).json({
      success: false,
      error: 'Error al obtener token 2-legged',
